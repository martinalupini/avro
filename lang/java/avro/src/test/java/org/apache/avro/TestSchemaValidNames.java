...
public class TestSchemaValidNames {
  ...
  public static Collection<Object[]> getParameters() throws JsonProcessingException {
    return Arrays.asList(new Object[][]{
        ...
        {getJsonNode(TypeJson.RECORD), "valid", getRecord("LongList"), false},
        {getJsonNode(TypeJson.ENUM), "valid", getEnum("Suit"), false},
        ...
        {getJsonNode(TypeJson.FIXED), "valid", getFixed("md5", 16), false},
